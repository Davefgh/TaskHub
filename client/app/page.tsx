    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-black shadow-sm sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-white">TaskHub</div>
          ...
          <div className="space-x-4">
            <a
              href="/login"
              className="px-4 py-2 text-white border border-white rounded-lg hover:bg-gray-900"
            >
              Login
            </a>
            <a
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="bg-gray-800 rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-400">Effort Tracked</p>
            </div>
            <div className="bg-gray-800 rounded-lg p-6 shadow-sm">
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-400">Chaos</p>
            </div>
          </div>
          ...
          <div className="space-x-4">
            <a
              href="/register"
              className="inline-block px-8 py-3 bg-white text-black rounded-lg hover:bg-gray-200 font-semibold"
            >
              Get Started Free
            </a>
            <a
              href="#features"
              className="inline-block px-8 py-3 bg-gray-700 text-white border-2 border-white rounded-lg hover:bg-gray-600 font-semibold"
            >
              Learn More
            </a>
          </div>
      ...
      <section id="features" className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-8 border border-gray-300 rounded-lg hover:shadow-lg transition bg-white">
              <CheckCircle2 className="w-12 h-12 text-black mb-4" />
              <h3 className="text-xl font-semibold text-black mb-3">Task Management</h3>
            ...
            <div className="p-8 border border-gray-300 rounded-lg hover:shadow-lg transition bg-white">
              ...
              <h3 className="text-xl font-semibold text-black mb-3">Kanban Board</h3>
              <p className="text-gray-600">
            ...
            <div className="p-8 border border-gray-300 rounded-lg hover:shadow-lg transition bg-white">
              ...
              <h3 className="text-xl font-semibold text-black mb-3">Project Organization</h3>
              <p className="text-gray-600">
            ...
            {/* Feature 5 */}
            <div className="p-8 border border-gray-300 rounded-lg hover:shadow-lg transition bg-white">
              <Bell className="w-12 h-12 text-black mb-4" />
              <h3 className="text-xl font-semibold text-black mb-3">Real-time Updates</h3>
              <p className="text-gray-600">
            ...
            {/* Feature 6 */}
            <div className="p-8 border border-gray-300 rounded-lg hover:shadow-lg transition bg-white">
              <Smartphone className="w-12 h-12 text-black mb-4" />
              <h3 className="text-xl font-semibold text-black mb-3">Responsive Design</h3>
              <p className="text-gray-600">
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-black mb-6">About TaskHub</h2>
